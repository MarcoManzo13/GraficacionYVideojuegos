...
namespace Actividad3
{
    public partial class Form1 : Form
    {
        ...
        // Botón que toma el ángulo proporcionado por un texto y crea y rota un cuadrado colocando su centro en el origen en el centro de la pantlla.
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            Point lineaRoja5 = RotatePoint(new Point(x1, y2), centro, anguloRadianes);
            Point lineaRoja6 = RotatePoint(new Point(x2, y2), centro, anguloRadianes);
